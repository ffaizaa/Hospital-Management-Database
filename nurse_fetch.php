...
<head>
    ...
    <title>Get Nurse Information</title>
                ...
                <div class="card mt-5">
                    ...
                    <div class="card-body">
                        ...
                        <form action="" method="GET">
                            <div class="row">
                                <div class="col-md-8">
                                    <input type="text" name="N_ID" value="<?php if(isset($_GET['N_ID'])){echo $_GET['N_ID'];} ?>" class="form-control">
                                </div>
                                <div class="col-md-4">
                                        ...
                                        foreach($QUERY_RUN as $row){
                                           ...
                                           ?>
                                                ...
                                                <div class="form-group mb-3">
                                                    ...
                                                    <input type="text" value="<?= $row['WORKING_SHIFT']; ?>" class="form-control">
                                                </div>
                                           <?php
                                        }
